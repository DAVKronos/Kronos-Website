...
function createMailingList(data) {
    return restCall(`mailinglists`, { method: 'POST', data: {mailinglist: data} }).then(res => res.data);;
}

function updateMailingList(id, data) {
    return restCall(`mailinglists/${id}`, { method: 'PUT', data: {mailinglist: data} }).then(res => res.data);;
}
